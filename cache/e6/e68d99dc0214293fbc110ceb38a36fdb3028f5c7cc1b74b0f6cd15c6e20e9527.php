...
class __TwigTemplate_7c6240dd9471272b1c5c551a624e6cdc2228142b909a119f6d0b5f7e87913be7 extends Twig_Template
{
...
{% block content %}
    ...
    {% for c in list %}
            <tr class=\"{% if loop.index is odd %}rowodd{% else %}roweven{% endif %}\">
                ...
                <td>{{c.description}}</td>
                <td><img src=\"{{c.imagePath}}\" width=\"100\" height=\"100\"></td>
                <td>
